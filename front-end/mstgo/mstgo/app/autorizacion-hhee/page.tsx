...
export default function AutorizacionHHEE() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    if (trabajador && date && hours) {
      const trabajadorSeleccionado = trabajadores.find(t => t.id === trabajador)
      setMessage(`Horas extras autorizadas con éxito para ${trabajadorSeleccionado?.nombre} el ${format(date, 'dd/MM/yyyy')} por ${hours} horas.`)
    } else {
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              ...
              <ol className="list-decimal list-inside mt-2">
                <li>Seleccione el trabajador para el cual desea autorizar horas extras.</li>
